...
func GetResApplyUser(apply *model.Apply, fromUser *model.User, toUser *model.User) *ResApply {
	tempApply := &ResApply{Id: apply.Id, FromId: apply.FromId, ToId: apply.ToId, Type: apply.Type, Reason: apply.Reason, Remark: apply.Remark, FriendGroupId: apply.FriendGroupId, Status: apply.Status, OperateTime: apply.OperateTime}
