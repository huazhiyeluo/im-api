...
/********************************对接口********************************/
// 群和群备注组合
func GetResGroup(group *model.Group, contact *model.ContactGroup) *ResGroup {
	tempGroup := &ResGroup{
...
// 群成员和群备注组合
func GetResGroupUser(user *model.User, contact *model.ContactGroup) *ResGroupUser {
	tempGroup := &ResGroupUser{
		Uid:        user.Uid,
